...
message(STATUS "Looking for libmongoc")
...
if(LIBMONGOC_FOUND)
    ...
    if (LIBFIND_DEBUG)
      message(STATUS "  LIBMONGOC_INCLUDE_DIRS=${LIBMONGOC_INCLUDE_DIRS}")
      message(STATUS "  LIBMONGOC_LIBRARY_DIRS=${LIBMONGOC_LIBRARY_DIRS}")
      message(STATUS "  LIBMONGOC_LIBRARIES=${LIBMONGOC_LIBRARIES}")
    endif(LIBFIND_DEBUG)
