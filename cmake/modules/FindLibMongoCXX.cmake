...
message(STATUS "Looking for libmongocxx")
...
if(LIBMONGOCXX_FOUND)
    ...
    if (LIBFIND_DEBUG)
      ...
      message(STATUS "  LIBMONGOCXX_LIBRARY_DIRS=${LIBMONGOCXX_LIBRARY_DIRS}")
      message(STATUS "  LIBMONGOCXX_LIBRARIES=${LIBMONGOCXX_LIBRARIES}")
    endif(LIBFIND_DEBUG)
