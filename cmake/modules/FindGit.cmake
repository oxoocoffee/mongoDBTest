...
if(GIT_EXECUTABLE)
  ...
  macro(GIT_WC_INFO dir prefix)
   ...
   execute_process(COMMAND ${GIT_EXECUTABLE} --no-pager show -s --format='%an' ${${prefix}_WC_REVISION_HASH}
      WORKING_DIRECTORY ${dir}
      OUTPUT_VARIABLE ${prefix}_WC_LAST_CHANGED_AUTHOR
      OUTPUT_STRIP_TRAILING_WHITESPACE)
    ...
    execute_process(COMMAND ${GIT_EXECUTABLE} status --porcelain
     WORKING_DIRECTORY ${dir}
     OUTPUT_VARIABLE ${prefix}_WC_DITRY
     OUTPUT_STRIP_TRAILING_WHITESPACE)

    if(NOT ${prefix}_WC_DITRY STREQUAL "")
        set(${prefix}_WC_DITRY "dirty")
        set(${prefix}_WC_REVISION "${${prefix}_WC_REVISION}-dirty" )
    endif(NOT ${prefix}_WC_DITRY STREQUAL "")
